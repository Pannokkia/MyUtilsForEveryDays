...
from MyUtilsForEveryDays.excel import get_max_rows,get_max_cols
...
num_rows = get_max_rows('/MyUtils/MyUtilsForEveryDays/Test/Test.xlsx')
print(num_rows)

num_cols = get_max_cols('/MyUtils/MyUtilsForEveryDays/Test/Test.xlsx')
print(num_cols)